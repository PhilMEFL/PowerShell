...
function GetWaitInterval([int] $waitTime){
    If ($waitTime -lt 1000) {
        return 100
    	}
...
Get-ChildItem "C:\NotBackedUp\Fabrikam\DKVWebServices" -Recurse -Exclude log,logs
$directory = Get-ChildItem "C:\NotBackedUp\Fabrikam\DKVWebServices" -Recurse -Exclude log,logs
$directory
$directory | ZipFolder